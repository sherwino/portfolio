...
"use strict";const getHomeData=firebase.database().ref("/home").once("value"),renderSections=a=>{a.forEach(a=>{createSection(a)})};getHomeData.then(a=>{const b=null===a||void 0===a?void 0:a.val();if(b&&null!==b&&void 0!==b&&b.sections){const a=b.sections.sort((c,a)=>(null===c||void 0===c?void 0:c.order)>(null===a||void 0===a?void 0:a.order));renderSections(a)}});
